...
Class ProductsController extends Controller {
    ...
    public function index () {
        $page = (!haspermission('','view_products') ? lang('Custom.permissionDenied' ): 'Inventory Stock');
        return view('admin/products/index',compact('page'));
    }

    function create($id) {
        $page = (!haspermission('','create_product') ? lang('Custom.permissionDenied' ): 'Edit Inventory Stock');
        $route = (!haspermission('','create_product') ? 'pages-error-404': 'admin/products/create');
    ...
    public function allProducts () {
        $page = (!haspermission('','view_products') ? lang('Custom.permissionDenied' ): 'Products');
