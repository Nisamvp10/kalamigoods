                        ...
                        <div id="variantWrapper">
                            <div class="border border-gray-200 rounded-lg p-4 new-row mt-2">
                                ...
                                <div>
                                    ...
                                    <input type="file" name="variant[]" class="bg-gray-100 border px-4 py-2 rounded hover:bg-gray-200 w-full" accept="image/jpeg, image/jpg, image/png, image/webp,image/svg+xml">
                                </div>
                            </div>
                        </div>
