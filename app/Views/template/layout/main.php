    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= strpos(uri_string(), 'admin/expertise') === 0  ? 'active' : '' ?>" href="<?= base_url(relativePath: 'admin/expertise') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= strpos(uri_string(), 'admin/partnership') === 0  ? 'active' : '' ?>" href="<?= base_url(relativePath: 'admin/partnership') ?>">
                ...
                if(haspermission('','achievements')) { ?>
                    <li class="nav-item disp">
                        <a class="nav-link <?= strpos(uri_string(), 'admin/achievements') === 0  ? 'active' : '' ?>" href="<?= base_url('admin/achievements') ?>">
                        <svg xmlns="https://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar "><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path></svg>
