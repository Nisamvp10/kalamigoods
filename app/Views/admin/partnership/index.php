    ...
    <div class="flex items-center justify-between">
        <div class="col-lg-12">
            <div class="d-flex justify-content-between align-items-center mb-0">
                ...
                <div>
                    <a onclick="openExpertiseModal()"  class="btn btn-primary"> 
                        <!-- onclick="toggleModal('bannerModal', true)"  -->
                        <i class="bi bi-plus-circle me-1"></i> Add Partnership
                    </a>
                </div>
                <?php } ?>
            </div>
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <!-- table -->
             <div class="overflow-x-auto">
                <div id="partnershipTable"></div>
            </div>
            <!-- close table -->
</div><!-- body -->
<!-- productModal -->

 <?= view('modal/partnershipModal');?>
<!-- view('modal/editBannerModal'); -->
 <?= view('modal/uploadGalleryModal');?>
 <!-- Cose Modal -->
<?= $this->endSection(); ?>
<?= $this->section('scripts') ?>
<script src="<?=base_url('public/assets/js/partnership.js');?>"></script>
