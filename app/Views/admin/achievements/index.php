    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden p-4">
        <div class="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <div class="flex-1 relative">
                ...
                <input type="text" id="searchProductInput" placeholder="Search Title..." class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
            </div>
            ...
            <!-- table -->
             <div class="overflow-x-auto">
                <div id="achievementTable"></div>
            </div>
            <!-- close table -->
</div><!-- body -->
<!-- productModal -->

 <?= view('modal/achievementModal');?>
<!-- view('modal/editBannerModal'); -->
 <?= view('modal/uploadGalleryModal');?>
 <!-- Cose Modal -->
<?= $this->endSection(); ?>
<?= $this->section('scripts') ?>
<script src="<?=base_url('public/assets/js/achievements.js');?>"></script>
<?= $this->endSection() ?>
