...
function openModal(id=false) {
    ...
    return String(text)
                        ...
                        let newRow = `
                            <div class="border border-gray-200 rounded-lg p-4 new-row mt-2">
                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        <input type="file" class="bg-gray-100 border px-4 py-2 rounded hover:bg-gray-200 w-full" name="variant[]" accept="image/jpeg, image/jpg, image/png, image/webp,image/svg+xml">
        ...
        <div class="border border-gray-200 rounded-lg p-4 new-row mt-2">
            ...
            <div>
                <label class="block mb-2 text-sm font-semibold">Image</label>
                <input type="file" class="bg-gray-100 border px-4 py-2 rounded hover:bg-gray-200 w-full" name="variant[]" accept="image/jpeg, image/jpg, image/png, image/webp">
            </div>
        </div>`;
...
function addVariantRow() {
    ...
    <div class="border border-gray-200 rounded-lg p-4 new-row mt-2">
        ...
        <div>
            <label class="block mb-2 text-sm font-semibold">Image</label>
            <input type="file" class="bg-gray-100 border px-4 py-2 rounded hover:bg-gray-200 w-full websc" name="variant[]" accept="image/jpeg, image/jpg, image/png, image/webp">
        </div>
